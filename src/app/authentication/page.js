...
const Authentication = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        setMessage(isRegistering ? 'Registration successful, you will be redirected to profile page within 2sec, if not please click the profile button ' : 'Login successful, you will be redirected to profile page with 2sec, if not please click the profile button');
